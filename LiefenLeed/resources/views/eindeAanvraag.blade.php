...
<div class="min-h-screen flex items-center justify-center py-12">
    <div class="bg-white shadow-xl rounded-2xl px-10 pt-10 pb-12 max-w-md w-full text-center">
        ...
        <div class="flex justify-center mb-6">
            <svg class="w-16 h-16 text-green-500" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-opacity="0.15" stroke-width="2.5" fill="currentColor" fill-opacity="0.05"/>
